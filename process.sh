...
cat output/person_linked.ttl output/rank_links.ttl output/unit_links.ttl output/documents_links.ttl output/casualties_processed.ttl > output/casualties_full.ttl &&
